...
public class DtoC5 {
    ...
    private Float average_daily_sales;
    private Integer difference_from_previous_month;

    public DtoC5(String month_name, Integer year, Float average_daily_sales, Integer difference_from_previous_month) {
    ...
    public Float getAverage_daily_sales() {
    ...
    public void setAverage_daily_sales(Float average_daily_sales) {
        this.average_daily_sales = average_daily_sales;
    }
